...
<?
	...
	$arrs = $mojetvrtke->getMojeTvrtkeInfo($_POST["id"]); 
...
?>
		...
		<form name="editProjectForm" id="editProjectForm" action="<?=$PHP_SELF?>" method="POST" autocomplete="off">
			<input type="hidden" name="editMT" value="1">
			...
			<table border="0" cellspacing="0" cellpadding="0" width="100%">
				...
				<tr>
					<td class="fieldKey" width="125"><div class="crosspiece100"></div>MBS</td>
					<td class="fieldValue" width="325"><input type="text" name="mbs" value="<?=$arrs[0]["mbs"]?>" class="input style" style="width: 275px" /></td>
				</tr>
				<tr>
					<td class="fieldKey" width="125"><div class="crosspiece100"></div>Banka</td>
					<td class="fieldValue" width="325"><input type="text" name="bank" value="<?=$arrs[0]["bank"]?>" class="input style" style="width: 275px" /></td>
				</tr>
				<tr>
